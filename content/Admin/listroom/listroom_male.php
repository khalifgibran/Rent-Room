<?php  
  ...
  //Male
  $totalDataPage = 5;
  $queryData = mysqli_query($db,"SELECT * FROM `room-male`");
  ...
  $queryM = mysqli_query($db,"SELECT * FROM  `room-male` LIMIT $earlyData, $totalDataPage");
       ...
       <div class="alert alert-light" role="alert">
          ...
          <div class="side-bar mb-5 row">
              ...
              <ul class="nav flex-column mt-5 ms-3 mb-3 ">
                ...
                <li class="nav-item">
                  <a class="nav-link text-white" href="listroom_male.php"><i class=" fas fa-person-booth me-3"></i>List Room</a><hr class="bg-secondary">
                </li>
                <li class="nav-item"> 
            ...
            <div id="list_room" class="col-md-10 mt-5 p-5 pt-5">
              ...
              <div class="row">
                <a  style="text-decoration: none; width: 100px; background-color: #313A46;" class="btn link_gender p-1 text-center text-white" href="listroom_male.php">
                  Male
                </a>

                <a  style="text-decoration: none; width: 100px;" class="ms-2 btn btn-outline-dark p-1 text-center" href="listroom_female.php">
                  Female
                </a>
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    <?php
                     foreach($dataM as $room_male) {   
                    ?>
                    <tr>
                      <td><b><?php echo $room_male['id']; ?></b></td>
                      ...
                      <td><span class="bg-danger p-2 text-center"><a href='../process/delete_male.php?id="<?php echo $room_male['id']; ?>"'><i class="fas fa-trash text-white"></i></a></span></td>
                    </tr>
                    <?php  
                    }  ?>
                  </tbody>
